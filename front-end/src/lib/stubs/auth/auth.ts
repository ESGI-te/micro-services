...
export interface LoginResponse {
    ...
    jwt: string;
    /**
     * @generated from protobuf field: auth.LoginResponse.STATUS status = 3;
     */
    status: LoginResponse_STATUS;
    /**
     * @generated from protobuf field: user.User user = 4;
     */
    user?: User;
}
/**
 * @generated from protobuf enum auth.LoginResponse.STATUS
 */
...
/**
 * @generated from protobuf message auth.ValidateRequest
 */
...
/**
 * @generated from protobuf message auth.ValidateResponse
 */
export interface ValidateResponse {
    ...
    userEmail: string;
    /**
     * @generated from protobuf field: user.UserRole userRole = 4;
     */
    userRole: UserRole;
    /**
...
class LoginResponse$Type extends MessageType<LoginResponse> {
    constructor() {
        super("auth.LoginResponse", [
            ...
            { no: 3, name: "status", kind: "enum", T: () => ["auth.LoginResponse.STATUS", LoginResponse_STATUS] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string jwt */ 2:
                    ...
                    break;
                case /* auth.LoginResponse.STATUS status */ 3:
                    message.status = reader.int32();
                    break;
                case /* user.User user */ 4:
    ...
    internalBinaryWrite(message: LoginResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* auth.LoginResponse.STATUS status = 3; */
        if (message.status !== 0)
...
/**
 * @generated MessageType for protobuf message auth.ValidateResponse
 */
